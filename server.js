...
// Map of partyCode -> Set of connected clients
const parties = new Map();
// Map of client -> { partyCode, playerName }
    ...
    ws.on('message', (data) => {
        try {
            ...
            if (msg.type === 'join') {
                ...
                // Forward to all other members of the party
